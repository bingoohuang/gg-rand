...
func uint128Payload(ksuid KSID) uint128 {
	return makeUint128FromPayload(ksuid.Data[TimestampSize:])
}
...
func (v uint128) ksuid(timestamp uint32) (out KSID) {
	binary.BigEndian.PutUint32(out.Data[:4], timestamp) // time
	binary.BigEndian.PutUint64(out.Data[4:12], v[1])    // high
	binary.BigEndian.PutUint64(out.Data[12:], v[0])     // low
	return
}

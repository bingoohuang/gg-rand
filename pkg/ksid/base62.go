...
// This function encodes the base 62 representation of the src KSID in binary
// form into dst.
//
...
// This function appends the base 62 representation of the KSID in src to dst,
...
// This function decodes the base 62 representation of the src KSID to the
...
func fastAppendDecodeBase62(dst []byte, src []byte) []byte {
	...
	n := len(dst)
	fastDecodeBase62(dst[n:n+Size], src)
	return dst[:n+Size]
}
